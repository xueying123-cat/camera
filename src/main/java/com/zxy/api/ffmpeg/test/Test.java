package com.zxy.api.ffmpeg.test;
...
public class Test {
	...
	public static void test2() throws InterruptedException {
		...
		manager.start("tomcat",
				"ffmpeg -re  -rtsp_transport tcp -i \"rtsp://admin:admin123@10.1.1.244/id=00\" -f flv -vcodec libx264 -vprofile baseline -acodec aac -ar 44100 -strict -2 -ac 1 -f flv -s 1280x720 -q 10 \"rtmp://127.0.0.1:1935/live/test\"");
