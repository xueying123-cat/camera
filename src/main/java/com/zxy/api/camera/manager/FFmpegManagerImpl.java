...
import com.zxy.api.ffmpeg.dao.TaskDaoImpl;
import com.zxy.api.ffmpeg.entity.TaskEntity;
import com.zxy.api.ffmpeg.service.CommandAssembly;
import com.zxy.api.ffmpeg.service.CommandAssemblyImpl;
import com.zxy.api.ffmpeg.service.OutHandlerMethod;
import com.zxy.api.ffmpeg.service.TaskHandler;
import com.zxy.api.ffmpeg.dao.TaskDao;
import com.zxy.api.ffmpeg.service.*;
...
public class FFmpegManagerImpl implements FFmpegManager {
    ...
    public String liveCommand(String rtspUrl, String rtmpUrl) {
        ...
        return "ffmpeg -re  -rtsp_transport tcp -i \""
                + rtspUrl
                + "\" -f flv -vcodec libx264 -vprofile baseline -acodec aac -ar 44100 -strict -2 -ac 1 -f flv -s 1280x720 -q 10 \""
                + rtmpUrl +"\"";
    }
